...
class AutomatorWP_BuddyBoss_Add_User_Activity extends AutomatorWP_Integration_Action {
    ...
    public function register() {
        ...
        automatorwp_register_action( $this->action, array(
            ...
            'label'             => __( 'Add an activity to the user', 'automatorwp-buddyboss' ),
            'select_option'     => __( 'Add an <strong>activity</strong> to the user', 'automatorwp-buddyboss' ),
            /* translators: %1$s: Activity. */
            'edit_label'        => sprintf( __( 'Add an %1$s to the user', 'automatorwp-buddyboss' ), '{activity}' ),
            /* translators: %1$s: Activity. */
            'log_label'         => sprintf( __( 'Add an %1$s to the user', 'automatorwp-buddyboss' ), '{activity}' ),
            'options'           => array(
                'activity' => array(
                    'default' => __( 'activity', 'automatorwp-buddyboss' ),
                    'fields' => array(
                        // Note: "action" key is reserved
                        'activity_action' => array(
                            'name' => __( 'Action:', 'automatorwp-buddyboss' ),
                            'desc' => __( 'Activity\'s action.', 'automatorwp-buddyboss' ),
                            'type' => 'text',
                            'default' => ''
                        ),
                        'content' => array(
                            'name' => __( 'Content:', 'automatorwp-buddyboss' ),
                            'desc' => __( 'Activity\'s content.', 'automatorwp-buddyboss' ),
                            'type' => 'wysiwyg',
                            'default' => ''
                        ),
                        'link' => array(
                            'name' => __( 'Link:', 'automatorwp-buddyboss' ),
                            'desc' => __( 'URL link associated to the activity.', 'automatorwp-buddyboss' ),
                            'type' => 'text',
                            'default' => ''
                        ),
                        'hide_sitewide' => array(
