...
class AutomatorWP_BuddyBoss_Send_Email_Invite extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User sends an email invite', 'automatorwp-buddyboss' ),
            'select_option'     => __( 'User sends an <strong>email invite</strong>', 'automatorwp-buddyboss' ),
            /* translators: %1$s: Number of times. */
            'edit_label'        => sprintf( __( 'User sends an email invite %1$s time(s)', 'automatorwp-buddyboss' ), '{times}' ),
            'log_label'         => __( 'User sends an email invite', 'automatorwp-buddyboss' ),
