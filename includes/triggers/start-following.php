...
class AutomatorWP_BuddyBoss_Start_Following extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User starts following someone', 'automatorwp-buddyboss-integration' ),
            'select_option'     => __( 'User <strong>starts following</strong> someone', 'automatorwp-buddyboss-integration' ),
            /* translators: %1$s: Number of times. */
            'edit_label'        => sprintf( __( 'User starts following someone %1$s time(s)', 'automatorwp-buddyboss-integration' ), '{times}' ),
            'log_label'         => __( 'User starts following someone', 'automatorwp-buddyboss-integration' ),
