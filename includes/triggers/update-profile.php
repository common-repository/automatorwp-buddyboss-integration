...
class AutomatorWP_BuddyBoss_Update_Profile extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User updates profile information', 'automatorwp-buddyboss' ),
            'select_option'     => __( 'User updates <strong>profile information</strong>', 'automatorwp-buddyboss' ),
            /* translators: %1$s: Number of times. */
            'edit_label'        => sprintf( __( 'User updates profile information %1$s time(s)', 'automatorwp-buddyboss' ), '{times}' ),
            'log_label'         => __( 'User updates profile information', 'automatorwp-buddyboss' ),
