...
class AutomatorWP_BuddyBoss_Join_Group extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User joins a group', 'automatorwp-buddyboss' ),
            'select_option'     => __( 'User <strong>joins</strong> a group', 'automatorwp-buddyboss' ),
            /* translators: %1$s: Group. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User joins %1$s %2$s time(s)', 'automatorwp-buddyboss' ), '{group}', '{times}' ),
            /* translators: %1$s: Group. */
            'log_label'         => sprintf( __( 'User joins %1$s', 'automatorwp-buddyboss' ), '{group}' ),
            ...
            'options'           => array(
                'group' => automatorwp_utilities_ajax_selector_option( array(
                    ...
                    'option_none_label' => __( 'any group', 'automatorwp-buddyboss' ),
            ...
            'tags' => array_merge(
                automatorwp_utilities_post_tags( __( 'Group', 'automatorwp-buddyboss' ) ),
